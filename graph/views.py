...
def home(request):
    ...
    x=[1,2,3,4,5]
    y=[6,7,8,2,1]
    plot = figure(title='Data visualization with bokeh', x_axis_label='x', y_axis_label='y')
    plot.line(x,y ,legend='test',line_width=2 ,color='red')

    script, div = components(plot)
    return render(request, 'graph/home.html', {'div': div, 'script': script})
...
def starter(request):
    ...
    plot=figure( title='Data visualization with bokeh', x_axis_label='x',y_axis_label='y')
    plot.circle([1,10,20,27],[0,0,0,0], size=20,color='blue')
    script ,div=components(plot)
    return render(request, 'graph/home.html' ,{'div':div,'script':script})
...
def hom(request):
    ...
    return render(request, 'graph/home.html', {'script': script, 'div': div})
...
def combo(request):
    ...
    return render(request, 'graph/combo.html' , {'script': script, 'div':div})
...
def programming(request):
    ...
    return render(request, 'graph/programming.html', {'script': script, 'div': div})
...
def products(request):
    ...
    return render(request, 'graph/product.html', {'script': script, 'div': div})
